      ...
      <main className="pt-24 pb-16">
        <div className="container mx-auto px-6">
          ...
          <div className="max-w-3xl mx-auto text-center mb-16">
            <span className="text-accent font-semibold text-sm uppercase tracking-wider">Press</span>
          ...
          <Card className="p-8 mb-16 text-center">
            ...
            <a href="mailto:Nebulatech.innovations@outlook.com" className="text-accent hover:underline">
            ...
            <div className="space-y-4">
              {pressReleases.map((release, index) => (
                <Card key={index} className="p-6 hover:border-accent/30 transition-colors">
                  <span className="text-sm text-accent">{release.date}</span>
                  <h3 className="text-lg font-semibold text-foreground mt-1">{release.title}</h3>
