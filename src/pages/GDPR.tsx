        ...
        <div className="container mx-auto px-6">
          <div className="max-w-3xl mx-auto">
            ...
            <Card className="p-8 space-y-6">
              <section>
                <h2 className="text-xl font-semibold text-foreground mb-3">Our Commitment to GDPR</h2>
              ...
              <section>
                ...
                <ul className="list-disc list-inside text-muted-foreground text-sm leading-relaxed space-y-2">
              ...
              <section>
                <h2 className="text-xl font-semibold text-foreground mb-3">Contact Our Data Protection Team</h2>
                <p className="text-muted-foreground text-sm leading-relaxed">
